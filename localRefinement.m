function [nodes,NE] = localRefinement(nodes,NE,BE,IE, X_BE_spline_top, X_BE_spline_bottom)
    ...
    while ~done
        ...
        [Iflagged,Bflagged] = FlagEdge(nodes,IE,BE, X_BE_spline_top, X_BE_spline_bottom);
        ...
        for e=1:nElem
            ...
            for k=1:3
                ...
                hdes = sizing((nodes(n1,:)+nodes(n2,:))/2, X_BE_spline_top, X_BE_spline_bottom);
